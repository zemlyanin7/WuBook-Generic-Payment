...
$ch = curl_init($pay_url . "payment/rest/register.do?amount=" . intval($deposit) . "00&currency=643&language=ru&orderNumber='" . $rcode . "'&password=" . $password . "&userName=" . $userName . "&returnUrl=" . $ok_url . "&failUrl=" . $ko_url . "&email=" . $email);
